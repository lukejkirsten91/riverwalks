          ...
          <div className="flex items-start justify-between gap-2 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 lg:gap-4 min-w-0 flex-1">
              ...
              <div className="flex gap-1 sm:gap-2">
                {/* Excel Export - Always available for free */}
                <button
                ...
                {/* Visualise Report (PDF) - Premium only */}
                ...
                return (
                  <div className="bg-white rounded-lg border border-gray-300 overflow-hidden map-container">
                    ...
                    <div className="relative">
                      {/* MapTiler Static API - clean background without markers */}
                      <img
                        src={`https://api.maptiler.com/maps/basic-v2/static/${centerLng},${centerLat},${zoom}/600x400.png?key=${process.env.NEXT_PUBLIC_MAPTILER_API_KEY}`}
